...
plotcrime = baseregioncrime + geom_point()+theme_classic()+labs(title.text = "Does No Health Insurance Cause Crime?")+theme(plot.title = element_text(h=0.5))
plotcrime

```
```{r}
basegdpcrime = ggplot(dataset, aes(x=HighSchoolGradPct, y=ViolentCrimeCapita))
gdpcrime = basegdpcrime + geom_point()
gdpcrime
