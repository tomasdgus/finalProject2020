...
plotcrime = plotcrime + geom_smooth(method="lm",se=FALSE)
plotcrime
...
baseregioncrime = ggplot(dataset[dataset$ViolentCrimePer1000<=10,], aes(x=UninsuredPCT, y=ViolentCrimePer1000))
plotcrime = baseregioncrime + geom_point()+theme_classic() + labs(title = "Does No Healthcare Cause Crime?",caption = "Source: US Census Bureau Current Population Survey")
